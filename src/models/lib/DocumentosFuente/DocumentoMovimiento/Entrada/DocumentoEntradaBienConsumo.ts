...
export class DocumentoEntradaBienConsumo extends DocumentoEntrada {
    ...
    static override type = 'DocumentoEntradaBienConsumo';
    override type = 'DocumentoEntradaBienConsumo';
    private __DocumentoEntradaBienConsumo!: 'DocumentoEntradaBienConsumo';
