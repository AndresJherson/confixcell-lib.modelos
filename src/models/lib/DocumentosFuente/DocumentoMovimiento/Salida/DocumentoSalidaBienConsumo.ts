...
export class DocumentoSalidaBienConsumo extends DocumentoSalida {
    ...
    static override type = 'DocumentoSalidaBienConsumo';
    override type = 'DocumentoSalidaBienConsumo';
    private __DocumentoSalidaBienConsumo!: 'DocumentoSalidaBienConsumo';
