...
export class EventoPendienteKardexBienConsumo extends Model {
    ...
    static override type = 'EventoPendienteKardexBienConsumo';
    override type = 'EventoPendienteKardexBienConsumo';
    private __EventoPendienteKardexBienConsumo!: 'EventoPendienteKardexBienConsumo';
