...
export class NotaVentaSalidaBienConsumo extends SalidaBienConsumo {
    ...
    static override type = 'NotaVentaSalidaBienConsumo';
    override type = 'NotaVentaSalidaBienConsumo';
    private __NotaVentaSalidaBienConsumo!: 'NotaVentaSalidaBienConsumo';
