...
import { Almacen, BienConsumo, Cast, ExecutionContext, OptionalModel, Prop, PropBehavior, SalidaRecurso } from '../../../../index';

@Prop.Class()
export class SalidaBienConsumo extends SalidaRecurso {

    static override type = 'SalidaBienConsumo';
    override type = 'SalidaBienConsumo';
    private __SalidaBienConsumo!: 'SalidaBienConsumo';
