...
export class SalidaBienConsumoValorEntrada extends SalidaBienConsumo {
    ...
    static override type = 'SalidaBienConsumoValorEntrada';
    override type = 'SalidaBienConsumoValorEntrada';
    private __SalidaBienConsumoValorEntrada!: 'SalidaBienConsumoValorEntrada';
