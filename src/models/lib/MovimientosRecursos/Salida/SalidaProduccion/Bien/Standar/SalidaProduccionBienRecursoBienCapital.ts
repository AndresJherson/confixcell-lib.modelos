...
export class SalidaProduccionBienRecursoBienCapital extends Model {
    ...
    static override type = 'SalidaProduccionBienRecursoBienCapital';
    override type = 'SalidaProduccionBienRecursoBienCapital';
    private __SalidaProduccionBienRecursoBienCapital!: 'SalidaProduccionBienRecursoBienCapital';
