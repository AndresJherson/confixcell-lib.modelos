...
export class SalidaProduccionBienStandar extends SalidaProduccionBien {
    static override type = 'SalidaProduccionBienStandar';
    override type = 'SalidaProduccionBienStandar';
    private __SalidaProduccionBienStandar!: 'SalidaProduccionBienStandar';
