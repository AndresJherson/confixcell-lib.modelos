...
export class NotaVentaSalidaProduccionServicioReparacion extends SalidaProduccionServicio {
    ...
    static override type = 'NotaVentaSalidaProduccionServicioReparacion';
    override type = 'NotaVentaSalidaProduccionServicioReparacion';
    private __NotaVentaSalidaProduccionServicioReparacion!: 'NotaVentaSalidaProduccionServicioReparacion';
