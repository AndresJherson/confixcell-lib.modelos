...
export class NotaVentaSalidaProduccionServicioReparacionRecursoBienConsumo extends Model {
    ...
    static override type = 'NotaVentaSalidaProduccionServicioReparacionRecursoBienConsumo';
    override type = 'NotaVentaSalidaProduccionServicioReparacionRecursoBienConsumo';
    private __NotaVentaSalidaProduccionServicioReparacionRecursoBienConsumo!: 'NotaVentaSalidaProduccionServicioReparacionRecursoBienConsumo';
