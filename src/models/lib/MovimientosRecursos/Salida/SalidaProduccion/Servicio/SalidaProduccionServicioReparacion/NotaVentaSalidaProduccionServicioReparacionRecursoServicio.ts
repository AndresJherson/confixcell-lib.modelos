...
export class NotaVentaSalidaProduccionServicioReparacionRecursoServicio extends Model {
    ...
    static override type = 'NotaVentaSalidaProduccionServicioReparacionRecursoServicio';
    override type = 'NotaVentaSalidaProduccionServicioReparacionRecursoServicio';
    private __NotaVentaSalidaProduccionServicioReparacionRecursoServicio!: 'NotaVentaSalidaProduccionServicioReparacionRecursoServicio';
