...
export class SalidaProduccionServicioActividad extends Model {
    ...
    static override type = 'SalidaProduccionServicioActividad';
    override type = 'SalidaProduccionServicioActividad';
    private __SalidaProduccionServicioActividad!: 'SalidaProduccionServicioActividad';
