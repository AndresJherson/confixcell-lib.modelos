...
export class SalidaProduccionServicioRecursoBienCapital extends Model {
    ...
    static override type = 'SalidaProduccionServicioRecursoBienCapital';
    override type = 'SalidaProduccionServicioRecursoBienCapital';
    private __SalidaProduccionServicioRecursoBienCapital!: 'SalidaProduccionServicioRecursoBienCapital';
