...
export class SalidaProduccionServicioRecursoBienConsumo extends Model {
    static override type = 'SalidaProduccionServicioRecursoBienConsumo';
    override type = 'SalidaProduccionServicioRecursoBienConsumo';
    private __SalidaProduccionServicioRecursoBienConsumo!: 'SalidaProduccionServicioRecursoBienConsumo';
