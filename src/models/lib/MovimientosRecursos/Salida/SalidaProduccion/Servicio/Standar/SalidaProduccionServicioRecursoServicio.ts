...
export class SalidaProduccionServicioRecursoServicio extends Model {
    ...
    static override type = 'SalidaProduccionServicioRecursoServicio';
    override type = 'SalidaProduccionServicioRecursoServicio';
    private __SalidaProduccionServicioRecursoServicio!: 'SalidaProduccionServicioRecursoServicio';
