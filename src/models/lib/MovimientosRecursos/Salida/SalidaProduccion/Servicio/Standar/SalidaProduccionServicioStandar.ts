...
export class SalidaProduccionServicioStandar extends SalidaProduccionServicio {
    ...
    static override type = 'SalidaProduccionServicioStandar';
    override type = 'SalidaProduccionServicioStandar';
    private __SalidaProduccionServicioStandar!: 'SalidaProduccionServicioStandar';
