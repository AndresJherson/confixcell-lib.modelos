...
export class MetadataPresetRecord<TValue extends Object = any, TModel extends Object = any> extends Immutable {
    ...
    override type = 'MetadataPresetRecord';
    private __MetadataPresetRecord!: 'MetadataPresetRecord';
...
export class PresetRecord extends Model {
    ...
    static override type = 'PresetRecord';
    override type = 'PresetRecord';
    private __PresetRecord!: 'PresetRecord';
